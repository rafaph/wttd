...
class TalkListGet(TestCase):
    def setUp(self) -> None:
        ...
        self.res = self.client.get(r('talk_list'))

    def test_get(self):
        self.assertEqual(200, self.res.status_code)

    def test_template(self):
        self.assertTemplateUsed(self.res, 'core/talk_list.html')
    ...
    def test_html(self):
        ...
        for count, expected in contents:
            with self.subTest():
                self.assertContains(self.res, expected, count)
    ...
    def test_context(self):
        ...
        for key in variables:
            with self.subTest():
                self.assertIn(key, self.res.context)
